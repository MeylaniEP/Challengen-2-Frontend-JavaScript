...
console.log('BUKU TERLARIS BERDASARKAN DATA DIATAS:', hasilInfoPenjualan.produkBukuTerlaris.namaProduk);
console.log('PENULIS TERLARIS BERDASARKAN DATA DIATAS:', hasilInfoPenjualan.penulisTerlaris);
